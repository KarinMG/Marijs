...
<html>
<head>
	 <title>Al het aanbod in de winkel</title>
...
?>
	 <div class="row">
	 	...
	 	<div class="main col-xs-12 col-sm-12 col-md-9">
	 		<div class="row">
			   	<h2 class="artikel">Alles in de winkel</h2>
	        	...
	        	$index_md = 1;
	        		...
	        		$resultaat = mysqli_query($conn, $sql);
				   	...
				   	<div class="artikel col-xs-12 col-sm-6 col-md-4">
						...
						/* //ook leverbaar met naam geboortedatum etc.
						if($rij["persoonlijk"] == 'on') // artikel kan gepersonaliseerd worden
						{
						?>
							<a href="personaliseren.php?artikelID=<?php echo($rij["artikelID"]); ?>" class="btn btn-default">Bestel met persoonlijke tekst</a>
						<?php
						} */
